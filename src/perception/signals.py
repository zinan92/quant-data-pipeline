"""Unified Signal Schema — local copy for Perception Layer.

Copied from trading-agents/src/signals/schema.py to avoid cross-repo
imports.  Keep in sync manually until a shared package is published.
...
class UnifiedSignal(BaseModel):
    ...
    def is_expired(self) -> bool:
        """Check whether the signal has expired."""
